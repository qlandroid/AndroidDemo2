...
import www.ql.com.okhttputils.widget.ListViewInterceptor;
...
public class MainActivity extends ListActivity {
    ...
    private ArrayList<Map<String, Object>> getData() {
        ...
        map.put("title", "题目");
        map.put("info", "内容");
        map.put("img", R.mipmap.shi);

        list.add(map);
        map = new HashMap<String, Object>();
        map.put("title", "题目");
        map.put("info", "内容");
        map.put("img", R.mipmap.tie);
